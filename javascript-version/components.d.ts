...
declare module 'vue' {
  export interface GlobalComponents {
    AnalyticsUserTable: typeof import('./src/components/AnalyticsUserTable.vue')['default']
    'AnalyticsUserTable_副本': typeof import('./src/components/AnalyticsUserTable_副本.vue')['default']
